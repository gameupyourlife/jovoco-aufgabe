  ...
  try {
    ...
    return <main className="min-h-svh bg-muted/30 px-4 py-8 sm:px-6">
      <div className="mx-auto flex max-w-7xl flex-col gap-8">
        <header className="flex flex-col gap-3"><p className="text-sm font-medium uppercase tracking-[0.2em] text-primary">Verwaltung</p><h1 className="font-heading text-4xl font-semibold tracking-tight">Geräteverwaltung</h1><p className="max-w-2xl text-muted-foreground">Bestand pflegen, Geräte ausmustern und die Historie dauerhaft nachvollziehbar halten.</p></header>
